...
python3 controls_main.py --S True --data True --regression_models True --expid 402
exit
EOF
docker stop kai_dlcdocker_data_tf15
python3 controls_main.py --S True --results True --regression_models True --expid 402
python3 controls_main.py --S True --analysis True --task_models True --expid 402