...
python3 controls_main.py --LSTM True --data True --task_models True --expid 404
python3 controls_main.py --LSTM True --data True --regression_models True --expid 404
exit
EOF
docker stop kai_dlcdocker_data_tf15
python3 controls_main.py --LSTM True --results True --task_models True --regression_models True --expid 404
python3 controls_main.py --LSTM True --analysis True --task_models True --expid 404
