...
The pipeline is run from the controls_main.py script from command line, e.g.
...
The pipeline uses the model weights saved in 'analysis-data/models' (in the Dropbox folder).
