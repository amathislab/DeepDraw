...
python3 controls_main.py --ST True --data True --regression_models True --expid 318
python3 controls_main.py --LSTM True --data True --regression_models True --expid 319
exit
EOF
